...
$router->group(['prefix' => 'cards'], function () use ($router){
    ...
    $router->patch('/{id}/take', ['as' => 'card.take_card', 'uses' => 'CardManagerController@takeCard']);
    $router->patch('/{id}/return', ['as' => 'card.return_card', 'uses' => 'CardManagerController@returnCard']);
    $router->patch('/return_all', ['as' => 'card.return_all', 'uses' => 'CardManagerController@returnAllCards']);
});
